...
<div align="left"><figure><img src="../../.gitbook/assets/image (54).png" alt="" width="375"><figcaption><p>Google Login 웹뷰에서 차단</p></figcaption></figure></div>

<div align="left"><figure><img src="../../.gitbook/assets/image (45).png" alt="" width="375"><figcaption><p>Facebook Login 웹뷰에서 차단</p></figcaption></figure></div>
...
3.  **User Agent Disallow를 회피하는 대안적인 방법은 무엇인가요?** 가장 일반적인 방법으로는 다음과 같은 접근 방식을 고려할 수 있습니다:
    ...
    * 스윙투앱에서 UserAgent 변경방법&#x20;
    ...
    &#x20;    **앱 제작 -> 고급 설정 -> 설정 창 콘솔박스 선택: "앱 제작 설정" 탭 선택 ->아래의 두개 값 변경**\
    &#x20;      <mark style="color:$primary;">IOS 웹뷰 UserAgent 값 / 안드로이드 웹뷰 UserAgent 값</mark>

<figure><img src="../../.gitbook/assets/이미지 4 (4).png" alt=""><figcaption></figcaption></figure>
...
{% hint style="success" %}
\*수정, 셋팅이 완료되면 앱 업데이트 해주셔야 합니다.

스토어에 출시된 앱은, 새로 제작된 버전으로 앱 업데이트 제출 해주셔야 반영됩니다.

스토어 출시 전 앱은 앱 업데이트 후 새 버전으로 확인해주세요.&#x20;
{% endhint %}
...
<figure><img src="../../.gitbook/assets/이미지 6 (6).png" alt=""><figcaption></figcaption></figure>

앱제작 ->고급설정  ->앱제작설정 탭 선택 -> 앱 URL스키마(custom url scheme) 확인
