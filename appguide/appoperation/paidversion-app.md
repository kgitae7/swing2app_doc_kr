...
[**결제/이용권 구매  - 유료앱 이용권 구매 페이지**](http://www.swing2app.co.kr/view/new_product_list_by_use_term) **이동하면, 이용권과 업로드티켓 구매 가능합니다.**
...
[웹뷰앱 제작  웹뷰전용 무제한 유료앱 이용권 추천 페이지](http://www.swing2app.co.kr/view/payment_list_by_recommend_voucher)

[푸시앱 제작 푸시전용 무제한 유료앱 이용권 추천 페이지](http://www.swing2app.co.kr/view/payment_list_by_recommend_voucher)
...
[**패키지 상품 구매 페이지**](http://www.swing2app.co.kr/view/new_product_list_by_package)
...
위에서 이용권 및 업로드 티켓을 모두 구매했다면, [**앱운영 → 버전관리 → 앱제작이력**](https://www.swing2app.co.kr/view/app_work_history) **페이지로 이동해서, 업로드 신청을 진행해주세요.**
...
<div align="left"><img src="https://wp.swing2app.co.kr/wp-content/uploads/2020/04/1-1.jpg" alt=""></div>
...
+[앱운영 페이지 → 서비스관리 → 리소스관리](http://www.swing2app.co.kr/view/storage_manager) 페이지에서 필요 없는 게시물을 삭제하여 용량을 확보할 수도 있습니다.
