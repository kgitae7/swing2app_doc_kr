...
<summary><strong>앱스토어 출시 후, 스토어 운영 관리는 안 해주나요?</strong></summary>

스토어 유지보수 서비스를 신청한 경우만 운영관리를 해드리고 있습니다.&#x20;

\*스토어유지보수:  정책 대응, 앱 업데이트, 스토어 이슈 해결 등 유지보수

그 외 스토어 유지보수 서비스를 이용하지 않는 경우는 모든 관리는 고객사가 직접 해주셔야 하며, 스윙투앱에서는 일체 관리를 해드리지 않습니다.&#x20;
