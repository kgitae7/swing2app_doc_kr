...
<div align="left"><figure><img src="../../.gitbook/assets/캡처 (3).PNG" alt=""><figcaption></figcaption></figure></div>
...
\*애플 인앱 결제 수수료는 1년 매출액이 10억 이하는 인앱 결제 수수료 15%, 10억 이상은 30% 수수료 발생됩니다.<br>
...
<div align="left"><figure><img src="../../.gitbook/assets/폰프레임1개.png" alt=""><figcaption></figcaption></figure></div>
...
### **7.구글 플레이스토어, 안드로이드폰 등** 타사 플랫폼 홍보

**-거절사례: 앱에 플레이스토어 홍보 이미지 혹은 문구를 기재한 경우/ 안드로이드 플랫폼 노출**
...
<mark style="color:red;">**\*허용 안되는 사례**</mark>
...
<div align="left"><figure><img src="../../.gitbook/assets/레임.png" alt=""><figcaption></figcaption></figure></div>

<div align="left"><figure><img src="../../.gitbook/assets/레임2.png" alt=""><figcaption></figcaption></figure></div>
...
<mark style="color:violet;">**\*신고, 차단 기능 이미지 참고**</mark>

<figure><img src="../../.gitbook/assets/게시물신고,사용자신고차단 (1).png" alt=""><figcaption></figcaption></figure>

<figure><img src="../../.gitbook/assets/사용자-생성정책 (1).png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/폐쇄형2개 (1).png" alt=""><figcaption></figcaption></figure>
...
### **11.**&#xC571; 실행 불가 및 로딩 오래 걸림

**-거절사례:** 웹사이트 해외 IP 차단, 안전망 적용되어 있을 경우 앱 실행 불가

<div align="left"><figure><img src="../../.gitbook/assets/image (20).png" alt="" width="382"><figcaption></figcaption></figure></div>

<div align="left"><figure><img src="../../.gitbook/assets/image (21).png" alt=""><figcaption></figcaption></figure></div>

웹사이트 해외 IP차단이 되어 있을 경우, 외국에서 앱을 열었을 때 에러 메시지가 뜨면서 앱이 실행되지 않습니다.

혹은 무한 로딩이 되면서 실행에 버그가 있을 수 있습니다.

앱스토어는 미국에서 심사를 하기 때문에 사이트가 해외 IP차단 되어 있을 경우 심사 자체가 불가합니다.

따라서 모든 국가에서 IP제한없이 앱이 실행되도록 해외 IP차단을 해제해야 합니다.

**\*한국에서만 이용하는 앱을 제출하더라도 앱은 모든 국가에서 실행 가능함을 원칙으로 합니다.**
...
[**test-flight 이용 매뉴얼**](https://wp.swing2app.co.kr/knowledgebase/appstore-testflight/)&#x20;

[**엔터프라이즈 이용 매뉴얼**](https://wp.swing2app.co.kr/knowledgebase/apple-developer-enterprise/)
...
### 15.선정적·성적 콘텐츠가 포함된 앱

<mark style="color:$primary;">**-거절사례:**</mark>**&#x20;**<mark style="color:$primary;">**앱 또는 웹사이트 내에 선정적 표현, 성적 암시 문구, 유흥업소 관련 콘텐츠가 포함된 경우**</mark>

앱스토어는 선정적이거나 성적 서비스를 암시하는 콘텐츠가 포함된 앱에 대해 매우 엄격하게 심사합니다.

특히 유흥 아르바이트, 마사지, 만남 서비스, 구인구직 형태의 웹사이트를 웹앱으로 제작하는 경우, 사이트 내 문구와 이미지에 선정적인 표현이 포함되어 있지 않은지 반드시 확인해야 합니다.

아래와 같은 내용이 포함되어 있을 경우 앱스토어 등록이 불가하거나 심사 거절될 수 있습니다.

**주의해야 할 콘텐츠 예시)**

* 여성의 외모, 몸매, 비주얼 등을 강조하거나 성적 이미지를 연상시키는 표현\
  예: 미인 상시 대기, 비주얼 출중, 외모 우수, 몸매 좋은 직원 등
* 성적 서비스를 암시하는 업종명 또는 은어 표현\
  예: 텐프로, 룸살롱, 에스코트 서비스, 성적 만남을 암시하는 문구 등
* 노출이 심하거나 선정적인 이미지, 프로필 사진, 배너 이미지
* 마사지, 유흥, 아르바이트 모집 등의 형태이지만 실제 서비스 내용이 성적 서비스를 연상시키는 경우
* 게시판, 후기, 프로필, 광고 배너 등에 성적 표현이나 선정적인 단어가 반복적으로 노출되는 경우

<div align="left"><figure><img src="../../.gitbook/assets/예시3.png" alt=""><figcaption></figcaption></figure> <figure><img src="../../.gitbook/assets/예시1.png" alt=""><figcaption></figcaption></figure></div>

<div align="left"><figure><img src="../../.gitbook/assets/예시2.png" alt=""><figcaption><p>성적 콘텐츠가 등록된 앱 화면 예시</p></figcaption></figure></div>

이러한 콘텐츠는 앱의 실제 목적과 관계없이 애플 심사 과정에서 부적절한 콘텐츠로 판단될 수 있습니다.

앱스토어 제출 전에는 웹사이트 전체 메뉴, 게시판, 이미지, 배너, 프로필, 광고 문구를 모두 점검해주시고, 선정적이거나 성적 서비스를 암시할 수 있는 표현은 반드시 삭제 또는 수정해주셔야 합니다.
...
-아이폰 사이즈에 맞추기 위해 이미지를 인위적으로 늘리거나 화면을 다 잘라놓은 경우<br>
{% endhint %}
...
앱스토어는 지원 URL이라고 하여, 홈페이지 링크를 함께 제출합니다.&#x20;

단, 공식 웹사이트만 되며 블로그나 인스타그램 같은 소셜 사이트 링크는 허용하지 않습니다.

이렇게 제공되는&#x20;

지원 URL에 개발자에게 연락할 수 있는 방법 즉, 정보를 기재해야 합니다.
...
{% hint style="info" %}
-**사업자 정보 기재 (사업자명, 대표자이름, 주소 등)**

**-문의 이메일(예: support@domain.com), 연락처 표시**

**-고객센터 경로 및 운영시간 (선택사항이며, 필수는 아님)**
{% endhint %}
...
**거절사례: 회원가입시 앱 이용에 관계없는 정보를 수집하는 경우**

* 앱은 핵심 기능을 수행하기 위해 필요한 정보만 필수로 요구해야 한다
* 필요하다면 입력 폼은 존재할 수 있으나 필수 입력으로 설정해서는 안 된다

**\*개인정보 관련 심사 거절 되는 앱 실행화면**&#x20;

<div align="left"><img src="https://documentation.swing2app.co.kr/~gitbook/image?url=https%3A%2F%2F684031119-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FmsJj00k8mj8AcVpnn9Xs%252Fuploads%252FaykVNACmnQZJjaFDPKO4%252F%25EC%258B%25AC%25EC%2582%25AC.png%3Falt%3Dmedia%26token%3D124d3df7-a44f-4d9a-8d0a-db001065ba21&#x26;width=768&#x26;dpr=3&#x26;quality=100&#x26;sign=c40fc069e9e42e398656b768b65ae7c0&#x26;sv=3" alt="회원가입에서 성별, 결혼유뮤는 앱 이용과 관계가 없습니다. " height="829" width="419"></div>

앱스토어는 회원가입시 수집되는 정보에 민감합니다.

수집되는 정보는 앱 이용에 실제 필수적인 관계가 있어야 함을 정책으로 따르고 있습니다.

**1) 불필요한 정보는 필수 입력에서 제거**

다음 항목이 앱 기능 수행과 직접적으로 관련 없다면 필수 항목에서 무조건 제거해야 합니다.

* 전화번호 (Phone number)
* 생년월일 (Date of birth)
* 성별, 결혼 여부, 주소 등

👉 단, 앱 기능상 정말 필요한 경우에는 선택 입력 사항으로 수정 후 명확한 근거를 제시 해야 합니다.

**2) 선택 입력(옵션)으로 변경**

위 정보가 사용자 프로필 완성이나 서비스 개선을 위해 필요하여 앱에서 제거가 불가하다면,

선택 입력사항으로 수정할 수 있습니다.

즉, 선택 입력은 회원가입시 해당 항목을 입력하지 않아도 가입이 가능한 조건으로 수정하는 것을 말합니다.

<div align="left"><img src="https://documentation.swing2app.co.kr/~gitbook/image?url=https%3A%2F%2F684031119-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FmsJj00k8mj8AcVpnn9Xs%252Fuploads%252FNVyrTIvQIXIyf9ldhCIs%252F%25EC%259D%25B4%25EB%25AF%25B8%25EC%25A7%2580%25206.png%3Falt%3Dmedia%26token%3Dcbb321ed-b4f4-4dec-b3cf-0fa698e9d8db&#x26;width=768&#x26;dpr=3&#x26;quality=100&#x26;sign=9fdf32d807c541726449bdaa7b7728ac&#x26;sv=3" alt="" height="824" width="416"></div>
