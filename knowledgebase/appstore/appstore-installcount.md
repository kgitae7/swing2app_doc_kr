...
<mark style="color:red;">\*앱스토어를 스윙투앱 계정으로 대리등록한 분들은 확인할 수 없습니다.</mark>&#x20;

<mark style="color:red;">사용자의 애플 개발자 계정으로 등록한 분들만 확인 가능해요!</mark>



\*구글 플레이스토어 앱 설치수 확인은 아래 매뉴얼을 확인해주시기 바랍니다.

**☞** [**플레이스토어 앱설치수 확인방법 매뉴얼**](https://documentation.swing2app.co.kr/knowledgebase/playstore/manage/playstore-installcount)

{% embed url="https://documentation.swing2app.co.kr/knowledgebase/playstore/manage/playstore-installcount" %}

***



## <mark style="color:blue;">**1. 앱스토어 커넥트 사이트 접속**</mark>
...
{% hint style="success" %}
<mark style="color:green;">**추가 안내**</mark>
...
## <mark style="color:blue;">**2.개요**</mark>&#x20;
...
## <mark style="color:blue;">**3. 판매량**</mark>&#x20;

앱스토어는 앱 **‘다운로드수’ = ‘판매량’**&#xC73C;로 표시해요. 같은 의미로 쓰이니 동일하게 봐주세요 ^^&#x20;
...
<figure><img src="../../.gitbook/assets/애플통계.png" alt=""><figcaption></figcaption></figure>

***



## <mark style="color:blue;">**4. 앱 설치수 통계 다운로드**</mark>
