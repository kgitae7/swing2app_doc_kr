...
&#x20;**\*필수\***  파일 등록을 해야 앱스토어 출시가 가능합니다. (25년 7월 11일 정책 변경)

**앱스토어, 플레이스토어 2군데 모두 출시할 예정이라면 app-ads.txt 파일 필수 등록 요청드립니다.** &#x20;
...
1단계: app-ads.txt 파일 확인 및 앱에 코드 스니펫 적용하기

2단계: 개발자 웹사이트 구축 및 스토어 정보에 개발자 웹사이트 추가하기

3단계: 플레이스토어, 앱스토어 심사 제출하기&#x20;

4단계: AdMob이 app-ads.txt 파일을 크롤링하고 확인할 때까지 기다리기

5단계: AdMob 계정에서 app-ads.txt 파일이 확인되었는지 살펴보기
{% endhint %}

{% hint style="success" %}
app-ads.txt 파일등록을 위해서는 개발자의 웹사이트(홈페이지)가 있어야 합니다.

없을 경우는 스윙투앱 홈페이지 링크를 제출해서 진행이 가능한 점 참고해주세요.&#x20;
{% endhint %}

<figure><img src="../../.gitbook/assets/구분선 (3).PNG" alt=""><figcaption></figcaption></figure>

## **STEP1. app-ads.txt 파일 확인 및 앱에 코드 스니펫 적용하기**

​

### **1. app-ads.txt 파일에 맞춤설정된 코드 스니펫 추가하기**

{% embed url="https://apps.admob.com" %}
...
<figure><img src="../../.gitbook/assets/이미지 19.png" alt=""><figcaption></figcaption></figure>

4\)연결할 앱 선택&#x20;

5\)상단 \[app-ads.txt] 탭을 선택합니다.
...
6\)app-ads.txt 설정 방법을 클릭합니다.

7\)복사할 코드 스니펫 옆에 있는 ![](https://lh3.googleusercontent.com/7kjkT9hCjpcFg8nA83VtPX1vD8WzPm_Ja0HkVtUTnWJ1kfEGGYlzIq2nY__xF2r9bzc) 을 클릭합니다.

​

### **2.복사한 코드 스니펫을 스윙투앱 \[애드몹 플러그인 설정화면]에서 붙여넣기 해주세요.**

복사한 코드를 스윙투앱 애드몹 플러그인 설정화면에 입력해야 합니다.
...
1\)[서비스관리-부가서비스관리-애드몹 플러그인 설정](https://www.swing2app.co.kr/view/app_plugin_by_admob) 이동
...
{% hint style="warning" %}
전면 광고 아이디, 배너 광고 아이디, 애드몹 앱 아이디가 모두 입력 되어 있어야 합니다.

광고 아이디, 앱 아이디를 모두 입력 한 뒤, app-ads.txt 복사값을 붙여야만 정상적으로 적용됩니다.&#x20;
{% endhint %}



<mark style="color:purple;">**\*app-ads.txt 적용한 앱은 앱제작 화면으로 이동하여 - 앱 업데이트 한번 더 해주세요.**</mark>
...
새 버전으로 제작되면, 해당 버전의 앱을 **플레이스토어 혹은 앱스토어에 제출을 하셔야 합니다.**

***



## STEP2. **개발자 웹사이트 구축 및 스토어 정보에 개발자 웹사이트 추가하기**



### <mark style="color:blue;">**1.개발자 웹사이트 제출**</mark>
...
### <mark style="color:blue;">**2.Google Play**</mark>&#x20;

[Play Console](https://play.google.com/apps/publish/signup/)에 로그인 - 앱 선택

<figure><img src="../../.gitbook/assets/이미지7 7 (1).png" alt=""><figcaption></figcaption></figure>

1. 왼쪽 메뉴에서 사용자늘리기:  **앱 정보→ 스토어 설정** 선택합니다.
2. 스**토어 등록정보 연락처 세부정보에서 \[수정] 버튼 선택**
3. 웹사이트 입력란: 개발자 웹사이트 URL을 입력해주세요. \
   \*사용자의 웹사이트가 없으실 경우 스윙투앱 홈페이지(http://www.swing2app.co.kr) 링크로 넣어주세요.
4. \[저장] 버튼 선택&#x20;



### <mark style="color:blue;">**3.Apple App Store**</mark>

&#x20;**스토어 등록정보의 마케팅 URL 입력란에 개발자 웹사이트를 추가합니다.**

<div align="left"><figure><img src="../../.gitbook/assets/이미지 7 (3).png" alt=""><figcaption></figcaption></figure></div>
...
### <mark style="color:blue;">**4.스토어 업데이트 유무**</mark>
...
## **STEP3.플레이스토어, 앱스토어 앱(업데이트) 제출**

플레이스토어는 새로 제작된 버전의 앱으로 프로덕션에 제출해서 심사 받아주세요.

\*앱스토어는 업로드 대행만 가능하기 때문에, 신규 등록 혹은 업데이트시 <mark style="color:red;">앱스토어 업로드티켓(20,000원) 구매 후 다시 신청해주셔야 합니다.</mark>
...
## **STEP4. AdMob이 app-ads.txt 파일을 크롤링하고 확인할 때까지 기다리기**
...
## **STEP5. AdMob 계정에서 app-ads.txt 파일 확인**
...
app-ads.txt 파일을 등록한다고 해서 앱에서 광고 노출이 더 잘 되거나, 수익을 더 발생시키는 구조는 아닙니다.

다만, 보안을 위해 구글 및 애플에서 셋팅을 권장하기 때문에 등록을 해주시기 바랍니다.
