---
description: 플레이스토어에 앱을 등록하여 출시하는 방법_2026년 4월 업데이트 버전
---
...
{% hint style="info" %}
앱 만들기 전, **'Android 개발자 인증' 먼저 등록 후 진행해야 합니다.**

Android 개발자 인증 방법은 아래 가이드 보시고 진행해주시구요.

**등록이 완료되면 앱만들기 시작해주세요.**

**🔗**[**Android 개발자 인증 등록** ](https://documentation.swing2app.co.kr/knowledgebase/playstore/developer-verification)[**방법**](https://documentation.swing2app.co.kr/knowledgebase/playstore/developer-verification)
{% endhint %}
...
개발자인증 등록 후 <mark style="color:blue;">**\[앱 만들기]**</mark> 버튼을 선택합니다.



<figure><img src="../../.gitbook/assets/앱만들기1.png" alt=""><figcaption></figcaption></figure>

1\)앱이름 (플레이스토어 출시되는 이름)

2\)패키지 이름 입력 \*앱제작시 발행되는 패키지 이름이 있습니다. 아래 패키지이름 확인방법 참고해주세요.
...
3\)사용 가능 여부 확인 체크  \*"이 앱을 만드는데 사용할 수 있습니다" 메시지 떠야 등록 가능합니다

4\)기본언어: 한국어 선택 (특정 국가에 배포되어야 한다면 해당 언어로 선택합니다. 예)미국)

5\)앱 또는 게임 선택: 앱으로 선택해주세요.

6\)유료 또는 무료 선택 (앱을 유료로 판매할 경우 ‘유료’ 선택, 무료 선택시 이후에 유료로 변경할 수 없습니다)



<figure><img src="../../.gitbook/assets/앱만들기2.png" alt=""><figcaption></figcaption></figure>

-선언-

7\)개발자 프로그램 정책 체크

8\)Play 앱 서명 서비스 약관 동의에 체크
...
어떤 국가에 출시를 할지 선택을 하는데요.&#x20;

'대한민국'만 선택하거나 or 전체 국가를 선택해주세요.&#x20;
