...
**구글 플레이 콘솔 정책 - 민감한 권한 API: 쿼리 권한 정책 입력 방법**

구글 플레이스토어 앱 등록 혹은 앱 출시 후 알아둬야 하는 정책사항에 대해 안내드립니다.
...
업데이트 된 버전의 앱으로 플레이스토어에 다시 업데이트 해주시구요.

아래 조치사항 내용을 확인하여 구글 플레이 콘솔에서 정책 내용 기재 후 심사를 다시 받아주세요.
...
\-새로 제작된 버전의 앱으로 플레이스토어에 다시 올려주세요

\-그리고 위의 본문에 기재된 것처럼, 플레이 콘솔 정책에 들어가서 내용을 모두 입력한 다음 업데이트 심사를 받아주시면 됩니다.
