...
대충 입력하거나 질문에 다른 엉뚱한 대답을 하거나,질문에 대한 답변이 기대에 미치지 못해도 프로덕션 승인이 반려될 수 있습니다.
...
1\)비공개 테스트에 참여하는 사용자를 어떻게 모집하셨나요? 예를 들어 친구나 가족에게 부탁하셨나요?
...
10\)비공개 테스트에서 알게 된 내용을 바탕으로 앱을 어떻게 변경했나요?
