---
description: 안드로이드16 - API36 셋팅 완료된 앱 플레이 콘솔에 제출하는 방법
---

# 플레이스토어 API36 버전 앱 업데이트 제출하기

***



해당 방법은 구글 플레이스토어 안드로이드16(API36) 버전 업데이트를 진행하는 방법입니다.

<mark style="color:red;">**\*API 36레벨이 적용되는 버전은, 2026년 8월 5일 이후 제작된 앱부터 적용됩니다.**</mark>&#x20;

<mark style="color:red;">**이전에 제작한 앱은 반영이 안되오니 반드시 8월 5일 이후로 앱을 업데이트 해주세요.**</mark>
...
**스윙투앱 앱제작 시스템 API36 레벨로 셋팅을 완료했습니다.**

사용자분들은 앱을 새로 업데이트 해야 API36버전으로 앱이 다시 제작되고, 해당 앱을 플레이스토어에 제출해야 완료됩니다.

<mark style="color:red;">**\*API 36 업데이트는 2026년 8월 5일 이후 제작된 앱부터 적용됩니다.**</mark>&#x20;
...
<mark style="color:orange;">**\*올라간 앱 정보에 API 수준 21이상, 타켓 SDK에 36로 기재되어 있다면 API36버전으로 업데이트가 정상 적용 된 것입니다.**</mark>
...
<div align="left"><figure><img src="../../.gitbook/assets/정책해결.png" alt=""><figcaption></figcaption></figure></div>

<div align="left"><figure><img src="../../.gitbook/assets/정책해결2.png" alt=""><figcaption></figcaption></figure></div>

앱 업데이트 후 위의 메시지가 뜨면 조치가 완료된 것입니다.

정책 위반 해결됨 메시지 - 세부정보 보기 선택시

**앱이 안드로이드 16(API수준36) 이상을 타겟팅해야 함 - 문제 해결 완료됨 메시지를 확인할 수 있습니다.**

**해당 메시지까지 떠야 모든 작업 완료됩니다**.

<mark style="color:red;">\*해당 메시지가 떠야 정상적으로 조치(해결)가 완료된 것이오니, 반드시 체크해주세요.</mark>

<mark style="color:red;">앱이 업데이트 되어도 메시지는 하루 지나고 뜰 수 있으니, 업데이트 후 하루 정도 기다려주세요.</mark>&#x20;
