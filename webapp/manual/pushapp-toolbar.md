...
<figure><img src="../../.gitbook/assets/푸시툴바2.png" alt=""><figcaption></figcaption></figure>

푸시앱 툴바는 앱제작 - STPEP2디자인 단계에서 확인 가능합니다.

기본 스타일 및 옵션: 툴바 선택 - 툴바 사용하기에서 확인 가능

툴바는 사용으로 고정 셋팅 되어 있으므로, 수정이 필요할 경우 해당 단계에서 수정해주세요.
...
**💡**<mark style="color:$primary;">**툴바 노출을 원하지 않을 경우 - "미사용으로 체크 가능"**</mark>

<figure><img src="../../.gitbook/assets/푸시툴바.png" alt=""><figcaption></figcaption></figure>
...
### <mark style="color:blue;">**1)새로고침 툴바 메뉴 적용하기**</mark>
...
### <mark style="color:blue;">**2)툴바에서 제공되는 기본 기능**</mark>
...
### <mark style="color:blue;">**3)메뉴 리스트 수정방법**</mark>
...
### <mark style="color:blue;">**1)앱 실행화면**</mark>
...
### <mark style="color:blue;">2)툴바 아이콘 이미지 등록하기</mark>
