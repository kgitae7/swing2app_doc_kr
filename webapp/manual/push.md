...
<figure><img src="../../.gitbook/assets/푸시앱소개.jpg" alt=""><figcaption></figcaption></figure>
...
﻿푸시앱은모바일 웹사이트를 앱에 적용해서 제작하능 웹앱 제작 플랫폼입니다.
...
### <mark style="color:blue;">**제작방법 및 상품 구매, 스토어 출시 과정 가이드**</mark>

&#x20;

<mark style="background-color:yellow;">**• 1단계**</mark> <mark style="background-color:yellow;">**: 푸시전용 앱 제작 완료**</mark>

&#x20; \*앱 제작 방법은 아래 제작 매뉴얼로 확인해주세요.&#x20;

<mark style="background-color:yellow;">**• 2단계: 제작한 앱 확인하기**</mark>

&#x20; \*안드로이드폰으로 앱 다운받아 테스트할 수 있습니다.

&#x20; \*아이폰은 앱 다운 불가하기 때문에 앱스토어 출시 후 확인 가능합니다.

<mark style="background-color:yellow;">**• 3단계: 이용권 및 티켓 구매**</mark>&#x20;

&#x20; \*이용권을 구매해야 유료앱 버전으로 전환되며, 스토어 등록이 가능합니다.&#x20;

<mark style="background-color:yellow;">**• 4단계: 스토어 업로드 신청 (앱스토어, 플레이스토어 업로드 신청)**</mark>

&#x20; \*스토어 앱 등록은 스윙투앱에서 대행하여 진행해드립니다.&#x20;

&#x20; \*제공해드리는 스토어 업로드 신청서에 스토어별 기본 정보를 작성하여 신청합니다.&#x20;

<mark style="background-color:yellow;">**• 5단계: 스토어 심사 후 출시 완료**</mark>
...
<figure><img src="../../.gitbook/assets/웹뷰1.jpg" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/푸시2.jpg" alt=""><figcaption></figcaption></figure>
...
<mark style="color:red;">**📌그런데 가상머신에 에러 메시지가 뜨는데 왜 그런가요?**</mark>

<div align="left"><img src="../../.gitbook/assets/웹뷰5.PNG" alt=""></div>
...
**푸시앱으로 제작할 것이기 때문에 기능 사용은 ‘사용’으로 체크해주세요.**&#x20;
...
툴바 사용 여부는 선택입니다. (꼭 사용하지 않아도 됩니다)

툴바 ‘사용’으로 체크할 경우 툴바가 앱 화면 하단에 보여지게 되며, ‘미사용’으로 체크할 경우 툴바 영역이 앱에서 보여지지 않게 됩니다.

따라서 앱 스타일에 맞게 설정해주세요. \*앱제작 메이커에서 다시 수정 가능합니다.
...
<figure><img src="../../.gitbook/assets/푸시3.jpg" alt=""><figcaption></figcaption></figure>
...
<div align="left"><img src="https://wp.swing2app.co.kr/wp-content/uploads/2022/06/%EC%9D%B4%EB%AF%B8%EC%A7%80-16.png" alt=""></div>
...
<div align="left"><img src="../../.gitbook/assets/푸시4.png" alt=""></div>
...
<figure><img src="../../.gitbook/assets/아이폰미리보기.png" alt=""><figcaption></figcaption></figure>
...
만약 브라우저 미리보기에서도 연결이 거부된다면 문의게시판으로 문의주시기 바랍니다.
...
{% hint style="info" %}
<mark style="color:blue;">**푸시 앱제작 시간**</mark>
...
[앱제작이력](https://www.swing2app.co.kr/view/app_work_history) 페이지에서 제작완료된 앱(APK파일) 확인이 가능합니다.
...
<div align="left"><img src="../../.gitbook/assets/앱미리보기-1.png" alt=""></div>
...
<mark style="color:red;">\*푸시, 웹뷰앱은 안드로이드폰에서만 이용 가능해요. (아이폰은 브라우저 어플로 미리보기 확인해주세요!)</mark>



<div align="left"><figure><img src="../../.gitbook/assets/녹화_2020_09_09_15_12_16_838.gif" alt=""><figcaption></figcaption></figure></div>
...
### <mark style="color:blue;">**무제한 플랜) 푸시전용앱 무제한 이용권**</mark>
...
<figure><img src="../../.gitbook/assets/푸시결제.png" alt=""><figcaption></figcaption></figure>

[앱운영 →결제/이용권 구매 → 스윙투앱 이용권 추천 페이지](http://www.swing2app.co.kr/view/payment_list_by_recommend_voucher)로 이동해주세요

{% hint style="success" %}
<mark style="color:green;">**무제한 상품은 총 3가지이며, 출시하고자 하는 플랫폼에 따라 상품 구매가 가능해요**</mark>

<mark style="color:green;">**(업로드 티켓 금액 포함)**</mark>

(1)앱스토어, 플레이스토어 모두 출시한다면 **590,000원**

→ 푸시전용 무제한 유료앱(아이폰+안드로이드)550,000원+플레이스토어 업로드티켓20,000원+앱스토어 업로드티켓20,000원&#x20;

(2)플레이스토어만 출시한다면 **270,000원**

→ 푸시전용 무제한 유료앱(안드로이드)250,000원+플레이스토어 업로드티켓 20,000원

(3)앱스토어만 출시한다면  **370,000원**

→ 푸시전용 무제한 유료앱(아이폰)350,000원+앱스토어 업로드티켓20,000원
{% endhint %}
...
<div align="left"><figure><img src="../../.gitbook/assets/warning-(2) (4).png" alt=""><figcaption></figcaption></figure></div>
...
<summary>푸시 무제한 유료앱 주의사항</summary>

1\) 푸시 무제한 이용 중, 앱에 적용된 웹링크 주소를 변경해야 할 경우는 앱 업데이트가 필요합니다.&#x20;

앱제작→ 페이지 메뉴 단계→ 웹링크 주소 수정 후 \[저장], \[앱업데이트] 버튼 선택 후 새로 제작된 버전 앱으로 플레이스토어, 앱스토어 등에도 업데이트 해주셔야 합니다. &#x20;
...
1단계 앱 기본정보를 변경하실 경우 \[앱업데이트]버튼을 선택해서 새 버전으로 업데이트 해주세요.
...
<div align="left"><figure><img src="../../.gitbook/assets/유료버전3.jpg" alt=""><figcaption></figcaption></figure></div>

### **1.업로드 신청서 접수 및 스토어 심사 진행**

신청이 완료되면, 스윙투앱의 플레이스토어 업로드 담당자 / 앱스토어 업로드 담당자가 사용자분의 앱을 스토어에 올려드리는 업로드 진행을 시작합니다.

<mark style="color:orange;">\*앱스토어,플레이스토어 심사 기간: 7일</mark>
...
6\)플레이스토어 업로드를 요청하실때는 구글 개발자 계정은 반드시 '조직'으로 만들어주세요 (23년 이후 발행시)\
조직 개발자 계정에서 앱 즉시 등록 가능합니다.
{% endhint %}
...
1\)출시 완료 메일, 카카오 알림톡(사용자 번호가 등록되어 있을 경우)이 발송해드립니다.
...
<mark style="color:red;">\*단, 푸시 무제한 상품을 이용하는 사용자분은 변경이 안됩니다.</mark>
...
앱에 적용된 웹링크 주소를 변경하는 것도 제작과 동일합니다.
