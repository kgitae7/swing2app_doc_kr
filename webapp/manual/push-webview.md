...
\*중요\* 웹뷰 무제한 플러그인 상품을 이용중인 앱에서는 웹링크 주소 변경할 경우, 자동 반영이 되지 않습니다.

앱 업데이트를 해야 반영이 되며 스토어 출시되었을 경우 해당 스토어에 앱을 업데이트 해야 합니다.&#x20;

결제 및 상세 페이지에 해당 내용 기재되어 있으며,  안내드리고 있으니 참고해주세요!

일반 이용권 이용중에는 저장시변경 가능합니다.
...
<figure><img src="../../.gitbook/assets/아이폰미리보기 (1).png" alt=""><figcaption></figcaption></figure>
