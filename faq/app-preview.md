...
<img src="../.gitbook/assets/앱미리보기-1 (1).png" alt="" data-size="original">
...
앱 미리보기는 실제 앱을 설치하지 않고 웹뷰 형태로 앱 화면과 기능을 확인하는 용도이기 때문에, 푸시 알림처럼 디바이스 권한이 필요한 일부 기능은 정상적으로 작동하지 않습니다.

**-푸시 알림을 테스트하려면 앱을 제작한 뒤, 안드로이드폰에 APK파일 앱을 설치하여 테스트해주세요.**

**-아이폰은 무료 버전에서 테스트 불가하며, 유료앱 이용권과 앱스토어 업로드티켓 구매 후 앱스토어**

**TestFlight(iOS)로 설치한 후 확인할 수 있습니다.**
...
<summary><strong>프로토타입: 푸시, 웹뷰로 제작한 앱도 스윙미리보기에서 확인할 수 있나요?</strong></summary>

안드로이드폰에서는 \[앱 다운로드]로 확인이 가능하며, **아이폰에서는 확인할 수 없습니다.**

-안드로이드폰 프로토타입 – 푸시, 웹뷰로 제작한 앱은 스윙미리보기 \[앱 다운로드]만 가능합니다.

아이폰은 스윙투앱 웹뷰 브라우저를 통해 미리보기로 확인해주세요&#x20;

**🔗스윙투앱 브라우저 이용 방법**

{% embed url="https://documentation.swing2app.co.kr/appguide/webappconverter" %}
...
푸시, 웹뷰로 제작한 앱은 아이폰에서 브라우저 어플을 이용하여 미리보기로 확인해주세요.&#x20;
