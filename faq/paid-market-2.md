...
네, 구글 플레이스토어에 앱을 출시하시려면 **구글 개발자 계정을 직접 만드셔야 합니다.**

구글 정책상 대리등록이 불가능하기 때문에, 사업자명의의 조직 계정 혹은 본인 명의의 구글 개발자 개인 계정을 먼저 등록하셔야 해요.

**진행 방식은 이렇습니다:**

1. 고객님께서 구글 개발자 계정을 직접 생성하시고
2. 플레이스토어 업로드 신청 시 구글 개발자 계정 초대를 해주시면,
3. 저희가 고객님의 계정으로 앱을 등록해드립니다

**계정 등록 방법은 아래 가이드를 참고해주세요:**
...
구글 개발자 계정 등록 과정에서 궁금하신 점이 있으시면 언제든 말씀해주세요!
...
구글 개발자 계정은 개인 또는 조직 계정으로 등록할 수 있으며, 등록 절차와 필요한 정보가 상세히 정리되어 있습니다.

☞ 구글 개발자 '조직' 계정 등록 방법 확인하기

{% embed url="https://documentation.swing2app.co.kr/knowledgebase/playstore/google-businessdeveloper" %}

☞ 구글 개발자 '개인' 계정 등록 방법 확인하기

{% embed url="https://documentation.swing2app.co.kr/knowledgebase/playstore/google-developer" %}

가이드에는 계정 생성 절차, 필요한 정보, 등록 비용, 주의사항 등이 자세히 안내되어 있으니 참고하시면 됩니다.

등록 과정에서 궁금한 점이 있거나 추가 도움이 필요하시면 말씀해주세요..
...
네, 플레이스토어에 출시된 앱은 게시 취소 or 조건에 부합할 경우만 삭제가 가능합니다.
...
{% embed url="https://documentation.swing2app.co.kr/knowledgebase/playstore/manage/unpublish" %}

**\[플레이스토어 출시 앱 삭제 방법]**

앱 삭제 조건에 부합하면, 콘솔에서 앱 삭제를 할 수 있습니다.
...
플레이스토어는 키워드 입력란이 없습니다.

즉, 구글 플레이스토어는 키워드를 제출할 수 없습니다.

플레이스토어는 앱 이름으로 검색 노출이 됩니다.
...
**☞** [**플레이스토어 업데이트 매뉴얼**](https://documentation.swing2app.co.kr/knowledgebase/playstore/palystore-update)<br>

</details>

<details>

<summary><strong>플레이스토어 업데이트 진행 중 기존 버전or 패키지가 같다는 메시지가 뜹니다.</strong></summary>
...
다만 심사 거절 사유가 스윙투앱에서 해결하지 못하는 내용이거나 기술적인 이유로 스토어 출시가 불가하다고 판단되면 구매하신 업로드 티켓 환불을 보장해드립니다.
...
스윙투앱스토어 유지보수 서비스를 운영하고 있습니다.&#x20;

스토어 유지보수 서비스를 계약한 사용자분들은 계약 기간 동안 앱스토어, 플레이스토어 등 출시된 앱 운영 관리를 도와드립니다.&#x20;

**단, 스토어 유지보수 계약을 하지 않을 경우는**

**\*스윙투앱은 앱 출시까지만 대행만 진행해드리며, 출시 이후 앱 관리 및 스토어 운영 관리를 해드리지 않습니다.**

앱 관리 및 스토어 유지관리는 사용자분께서 운영하셔야 합니다. &#x20;

스윙투앱은장기 미 업데이트 및 정책 초치를 하지 않아 생기는 문제에 대해서 책임지지 않으니, 사용자분의 계정과 스토어는 직접 관리해주셔야 합니다.&#x20;

**다만 이렇게 도와드리고 있습니다:**

* 플레이스토어에서 정책 문제가 발생하거나 신규 정책이 업데이트되면, 조치 방법에 대한 매뉴얼을 제공해드립니다
* 직접 조치가 어려우신 경우, 플레이스토어 업로드 대행 서비스를 신청하실 수 있습니다
