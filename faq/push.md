...
[앱운영-서비스관리-앱 운영관리-앱 고급관리 - API KEY관리](https://www.swing2app.co.kr/view/app_advanced_management_by_api_key) 에서 확인 가능합니다.
...
* 푸시 API로 발송할 경우 사용자 아이디는 최대 100명까지만 지정 가능합니다
* 자세한 API 연동 방법과 파라미터 정보는 아래 개발자 문서를 참고해주세요

**관련 문서:**

* 푸시 API 연동 가이드: https://documentation.swing2app.co.kr/developer/server-side-api/push-api-notification
* 툴바 없이 푸시 알림 설정하는 방법: https://documentation.swing2app.co.kr/developer/webview/javascript-api#go-to-set-notification

APP ID와 API Key 확인이 어려우시거나 추가로 궁금하신 점이 있으시면 말씀해주세요.

</details>

<details>

<summary><strong>푸시 발송 수, 회원 수 제한이 있나요?</strong></summary>
...
<summary><strong>푸시 기능도 무료로 이용 가능한가요?</strong></summary>
...
<summary><strong>푸시 발송시 회원을 선택할 수 있나요?</strong></summary>

﻿일반 프로토타입 앱은 회원을 선택하여 발송할 수 있습니다.

원하는 사용자, 그룹을 선택하여 푸시를 보낼 수 있습니다.

단, 푸시 전용앱은 웹사이트 회원연동을 하지 않을 경우 전체회원만 발송 가능합니다.

회원 연동을 해야, 회원목록에서 사용자 리스트가 뜨며 개별 회원 선택할 수 있습니다.

</details>

<details>

<summary><strong>원하는 날짜, 시간대에 푸시를 보낼 수 있나요?</strong></summary>
...
<summary><strong>푸시 발송시 웹링크 혹은 앱 내 특정 페이지로 이동하게끔 적용이 가능한가요?</strong></summary>
...
푸시앱은 웹사이트 회원연동을 해주셔야, 회원 선택이 가능합니다.

회원 연동을 하지 않을 경우는 전체 발송만 가능합니다.&#x20;
...
따라서 개별 회원을 선택하거나, 그룹을 선택하길 원하면 웹사이트 회원 연동을 해주세요&#x20;

🔗[웹사이트 회원 연동 가이드 보러가기](https://documentation.swing2app.co.kr/developer/webview/user-integration)

</details>

<details>

<summary><strong>[푸시전용앱] 회원 연동을 통해 스윙투앱 푸시를 연동할 수 있나요? (푸시 API연동)</strong></summary>

﻿네 가능합니다.

가이드를보시고직접 셋팅하여 이용하실 수 있구요.&#x20;

회원 연동이 되면 앱운영-회원조회에서 가입된 회원이 연동됩니다.
...
푸시전용앱은 웹사이트(홈페이지)링크를 그대로 앱에 적용해서 만든앱이기 때문에 앱에서 연동되는 회원이 없습니다.
...
만약 웹사이트 회원 연동을 하셨다면, 사이트에서 가입한 회원이 앱으로 연동되며 앱에서도 회원수가 카운팅이 됩니다.

발송 회원수는 연동된 회원수로 실제 보여지게 됩니다.

푸시앱 회원 연동을 원하시면, 아래 가이드를 보시고 셋팅해주세요.
...
간혹 이모티콘 인식이 되지 않아, 푸시 발송에 문제가 생길 수 있습니다.&#x20;

발송된 푸시 이력을 확인하여 이모티콘 제거 후 다시 발송해주세요.&#x20;
