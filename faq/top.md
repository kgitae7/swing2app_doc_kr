...
**첫 번째는 **<mark style="color:red;">**\*중요\***</mark>** 스토어 배포(앱스토어, 플레이스토어 앱 출시)입니다.**
...
**세번째는 게시판 제작 개수 및 그룹 채팅방 개설 수에 차이가 있습니다.**
...
따라서 나중에 다시 이용권을 구매하시면 앱은 자동 복구되어 정상적으로 이용할 수 있구요.
...
<summary><strong>스윙투 홈페이지 탈퇴는 어떻게 하나요?</strong></summary>

회원탈퇴는 스윙투 홈페이지 앱운영 페이지의 오른쪽 상단 프로필 선택 → 내정보 수정 →회원탈퇴 선택해주시면 됩니다.&#x20;
...
☞ **** [**\[앱 관리자 설정방법 영상 확인하기\]**](https://wp.swing2app.co.kr/documentation/appmanage/pushmember/appmaster/)
...
**아이폰은 정책상 공식 앱스토에서 다운 받은 앱만 이용하게 되어있는데요.**

**대신에 아이폰 사용자분들은 미리보기로 앱을 확인할 수 있습니다.**

스윙투앱 공식앱에서 \[앱미리보기]를 이용하면 아이폰에서 제작한 앱을 ‘미리보기’로 확인할 수 있습니다.
