...
<mark style="color:blue;">**2. 장기이용: 푸시전용 무제한 유료앱 (한 번 결제시 기간 제한이 없이 무제한 이용 가능)**</mark>

<figure><img src="https://wp.swing2app.co.kr/wp-content/uploads/2020/09/%ED%91%B8%EC%8B%9C%EB%AC%B4%EC%A0%9C%ED%95%9C.png" alt=""><figcaption></figcaption></figure>
...
업로드티켓도 동일하게 각각 구매해주시면 됩니다. (플레이스토어 업로드티켓 5,000원 +앱스토어 업로드 티켓 20,000원)

**푸시전용 무제한 유료앱 상품은 일반 이용권과는 다른 이용 주의사항이 있습니다.**

**반드시 주의사항 및 이용방법을 확인해주시기 바랍니다.**

☞ [푸시무제한 유료앱 상품 이용방법 보러가기](https://wp.swing2app.co.kr/documentation/appmanage/pay/push-unlimited/)
