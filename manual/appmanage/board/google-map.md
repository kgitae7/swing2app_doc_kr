---
description: '구글맵 지도 게시판 : 구글맵에서 위치를 등록하고 이용하는 방법'
---
...
<mark style="color:red;">★ 위치 하나만 등록하는 경우 우선순위 입력하지 않아도 됩니다.</mark><br>
...
**\[리스트 열기]**&#xB97C; 선택하면 앞서 게시판에서 등록한 위치들이 리스트로 보여집니다. <br>
...
**\[길안내] 버튼을 선택하면 구글 지도페이지로 이동하여 길찾기를 안내해줍니다.**<br>
