...
![](https://wp.swing2app.co.kr/wp-content/uploads/2018/09/%EC%A7%80%EB%8F%84%EA%B2%8C%EC%8B%9C%ED%8C%90-%EC%A0%9C%EB%AA%A9.png)

**지도게시판 이용 방법**

<mark style="background-color:blue;">**▶**</mark>**지도게시판이란?**
...
<mark style="color:blue;">**앱 실행화면 – 지도게시판**</mark> <mark style="color:blue;"></mark><mark style="color:blue;"></mark>&#x20;
...
### <mark style="color:blue;">**STEP.1 지도 게시판 생성**</mark>
...
<mark style="color:orange;">**1.기본설정**</mark>
...
<mark style="color:orange;">**\*게시판 지정권한에 대한 상세 내용은 아래 매뉴얼 링크를 선택해주세요.**</mark>

**▶**[ **\[게시판 지정권한 사용방법 상세 매뉴얼 확인하기\]**](designated-authority.md)
...
<mark style="color:orange;">**2. 고급설정**</mark>
...
**☞** [**위치등록 게시판 고급설정 이용방법 보러가기**](map-advancedsettings.md)

만든 게시판에 위치를 등록해보겠습니다.

***

### <mark style="color:blue;">**STEP.2 지도게시판 – 위치등록하기**</mark>
...
<mark style="background-color:blue;">**▶**</mark>**  **<mark style="color:orange;">**위치를 추가할 때는 어떻게 하나요?**</mark>
...
**☞** [**\[구글맵(구글 지도) 게시판 이용방법 보러가기\]**](google-map.md)
