...
![](https://wp.swing2app.co.kr/wp-content/uploads/2019/01/%EA%B2%8C%EC%8B%9C%ED%8C%90%ED%97%A4%EB%8D%94-%EC%84%AC%EB%84%A4%EC%9D%BC.png)

게시판 기능 중 하나인! 게시판 헤더 이용방법에 대해서 알려드리겠습니다.

게시판 헤더 설정 방법, 헤더글을 설정하는 방법, 우선순위를 매겨서 순서대로 정렬하는 방법에 대해서 확인해주세요.

***

<mark style="background-color:blue;">**▶**</mark>**  **<mark style="color:blue;">**게시판 헤더란?**</mark>
...
### <mark style="color:blue;">**STEP.1 게시판 헤더 적용하기**</mark>
...
<mark style="color:purple;">**\*게시판을 새로 만들어야 한다면 \[게시판생성] 버튼 or 기존 게시판에 설정만 새로 한다면 \[설정]버튼을 눌러주세요.**</mark>
...
### <mark style="color:blue;">**STEP.2 게시물에 헤더 우선순위 적용하기**</mark>
...
<mark style="color:orange;">**\*우선순위는 헤더 영역에서 보여질 게시물 순서를 말해요.**</mark>

<mark style="color:orange;">**\*순서를 제일 앞으로 정하고 싶다면 숫자 1을 기재해주세요.**</mark>

<mark style="color:orange;">**\*다른 게시물들도 동일한 방법으로 2,3,4… 이렇게 숫자를 기재한 후 ‘저장하기’ 를 눌러주세요.**</mark>
...
### <mark style="color:blue;">**STEP.3 앱에 게시판 적용하기**</mark>&#x20;
...
### <mark style="color:blue;">**STEP.5 게시판 헤더글은 어떻게 내릴 수 있나요? (헤더글 삭제)**</mark>
...
<mark style="background-color:blue;">**▶**</mark>**  **<mark style="color:orange;">**앱 실행화면: 헤더글 삭제 후**</mark>
...
<mark style="color:purple;">**게시판 헤더기능은**</mark>

<mark style="color:purple;">**게시판에서 공지글이나 이벤트 글을 더욱 강조해서 보이게끔 하거나, 게시물 순서를 새로 정할 때,**</mark>&#x20;

<mark style="color:purple;">**오래된 게시글을 다시 앞 순서로 정렬하고자 할 때 유용하게 활용할 수 있습니다. ^^**</mark>
