...
<mark style="color:green;">안드로이드 패키지 아이디 변경은,</mark> <mark style="color:green;"></mark><mark style="color:green;">**유료앱 이용자만 이용 가능합니다.**</mark>
...
**2.패키지 변경은 스토어 출시 전 진행해주세요.**

출시가 되면 이미 패키지 아이디가 고정되므로, 변경도 되지 않지만 변경하더라도 새로운 앱으로 제작되어 기존 앱과 호환되지 않습니다.&#x20;
{% endhint %}
...
2.[앱운영-서비스관리-앱 운영관리-앱 고급관리](https://www.swing2app.co.kr/view/app_advanced_management_by_android)로 이동합니다.
...
\=> <mark style="color:red;">“com.swing2app.v3.app”</mark>&#x20;

<mark style="color:red;">앞에는 "com"이 있어야 하며, 소수점 "."이 3개 이상 들어가야 합니다.</mark>&#x20;



“d656b4c6a-e928-43a8-b25d-58a0ddf5f595”에서 'd' 를  'a'로 변경

숫자 '6' 제거 등으로 알파벳이나 숫자를 다른 것으로 변경해서 사용할 수 있습니다.&#x20;
{% endhint %}
...
3\)스토어 출시 전 변경해야 합니다. 스토어 출시가 진행되면 안드로이드패키지 아이디 변경이 불가합니다.&#x20;
{% endhint %}
