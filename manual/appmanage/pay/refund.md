...
* 사용하지 않은 상품은 환불 신청이 가능하며, 전액 환불 가능합니다. [\[내 결제 현황\]](http://www.swing2app.co.kr/view/payment_list) 환불 신청 가능
...
6\)커스터마이징 개발건으로 결제한 경우 개발 작업이 들어가기 전 [문의게시판](http://www.swing2app.co.kr/view/service_qa) 혹은 [채팅 상담](https://direct.lc.chat/12036120/) 으로 환불 요청을 해주셔야 합니다.
