...
<figure><img src="../../../.gitbook/assets/앱스토어등록1.png" alt=""><figcaption></figcaption></figure>

**1) 앱스토어 출시 앱 이름**

앱스토어에 출시되는 앱 이름을 기재해주세요.

<mark style="color:red;">\*제작한 앱 이름과 출시 앱이름을 다르게 기재하실 경우 앱스토어에는 출시이름으로 기재되며, 앱 다운로드를 하면 핸드폰에는 제작한 앱 이름으로 설치됩니다.</mark>

**2) 부제**&#x20;

앱 이름 아래에 표시되는 간단한 앱 소개 문구를 기재합니다. (30자 이내)

<mark style="color:red;">ex)노코드 앱제작 빌드 스윙투앱  , ex)패션, 뷰티 맞춤 전문 쇼핑몰 / 브랜드 패션 전문 공식 샵</mark>

**3) 키워드**&#x20;

앱을 설명하는 키워드를 입력합니다.(100자 이내)

<mark style="color:red;">어떤 키워드를 넣는지에 따라서 검색 결과가 달라지기 때문에 잘 유념해서 입력해주시구요.</mark>&#x20;

<mark style="color:red;">입력 가이드라인처럼< , > 로 구분해주세요.</mark>

**4) 자세한 설명**

앱을 설명하는 소개글을 작성합니다.&#x20;

<mark style="color:red;">\*최대한 자세히 입력해주세요 (소개가 제대로 안되어 있을시 심사가 거절되요)</mark>

<mark style="color:red;">주의: 회사 소개글이 아닌, 앱에 대한 소개(기능 및 앱에서 제공되는 메뉴,서비스)를 상세히 기재합니다.</mark>

**5) 6) 7) 8) 카메라&이미지&위치정보&\*마이크사용목적, 권한은 샘플 텍스트로 기재되어 있습니다.**&#x20;

내용 그대로 제출해도 된다면, 수정 하지 않아도 되구요.

앱에서 사용하는 권한이 있다면 정확히 기재해주세요.&#x20;

다만, 앱 제출시 담당자가 본 권한과 다른 내용이면 자체적으로 변경해서 제출할 수 있습니다.&#x20;



<figure><img src="../../../.gitbook/assets/앱스토어등록2.png" alt=""><figcaption></figcaption></figure>

**9)업데이트 변경사항**&#x20;

기존의 앱에서 새로운 버전으로 업데이트 하는 경우 변경된 내용을 작성해주시면 됩니다.
...
**12) 스크린샷 이미지: 아이폰 X기준 1242 x 2688px**&#x20;

**13) 스크린샷 이미지: 아이폰 14Pro Max 기준 1290 x 2796px**
...
아이폰이 없다면,  안드로이드폰으로 앱 화면 촬영한 다음 안드로이드 상단, 하단 상태 표시줄 제거&편집도구로 사이즈 수정해서 제출하셔도 됩니다.&#x20;
...
**14)아이패드 이미지**(사이즈:2048x2732px 또는 2732x2048px) <mark style="color:red;">\*선택사항</mark>&#x20;
...
등록하실  경우 아이패드에서 앱 실행한 화면으로 캡쳐해서 등록해주셔야 합니다.&#x20;

-아이폰에서 캡쳐한 화면을 인위적으로 사이즈 늘려서 넣을 경우 등록 불가합니다.&#x20;

-아이패드 스크린샷을 넣지 않을 경우 아이패드 사용자는 아이폰 스샷 이미지가 노출되며, 호환이 100% 완벽하지 않 을 수 있습니다.&#x20;

아이패드 앱 실행시 화면 최적화가 되지 않을 수 있습니다.

아이패드에도 최적화된 이미지 제출을 원한다면 아이패드용 스크린샷 이미지도 등록하시는 것을 추천드려요.
{% endhint %}



<figure><img src="../../../.gitbook/assets/앱스토어등록4.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/앱스토어등록5.png" alt=""><figcaption></figcaption></figure>

**18)업로드 계정 설정**

<mark style="color:red;">**\*중요\***</mark>**앱스토어 업로드 계정을 선택해주세요.**&#x20;

박스 칸의 가장 오른쪽 화살표 버튼을 클릭하면 계정을 선택할 수 있습니다.&#x20;

<figure><img src="../../../.gitbook/assets/녹화_2025_01_15_11_24_42_4.gif" alt=""><figcaption><p>스윙투앱 계정 체크</p></figcaption></figure>

<mark style="color:red;">\*애플 앱스토어는 스윙투앱 개발자 계정을 이용하여 계정 대리 등록이 가능합니다.</mark>&#x20;

<mark style="color:red;">or</mark>

<mark style="color:red;">사용자가 직접 애플 개발자 계정을 만들어서 본인의 애플 개발자 계정으로도 등록할 수 있습니다.</mark>
...
<figure><img src="../../../.gitbook/assets/앱스토어등록6.png" alt=""><figcaption></figcaption></figure>
...
<div align="left"><figure><img src="../../../.gitbook/assets/앱스토어등록7.png" alt=""><figcaption></figcaption></figure></div>
...
**22)&#x20;**<mark style="color:blue;">**\[신청하기]**</mark> 버튼을 누르면 앱스토어 업로드 신청이 완료됩니다.
...
<summary><strong>앱스토어에 스윙투앱으로 제작한 앱을 올리고 싶으면 어떻게해야 하나요?</strong></summary>

유료앱 이용권 구매하셔서 유료전환을 해주시구요. 앱스토어 업로드티켓을 구매합니다.&#x20;
...
<summary><strong>업로드 신청하면, 앱이 바로 앱스토어 출시되나요?</strong></summary>

스윙투앱에서 대행해서 앱을 앱스토어에 업로드 진행해드리는데요.

바로 출시되는 것이 아니라 애플 앱 심사를 받게 됩니다.

**앱스토어 심사기간이 약 1주일 소요됩니다.\*애플은 심사 기간이 긴 점 유념해주세요!**
...
### <mark style="color:blue;">**2)앱스토어 관련 약관 및 가이드**</mark>
