...
<mark style="color:red;">\*스크린샷 이미지는 위의 사이즈에 맞게 이미지를 작업해서 넣어주셔야 합니다.</mark>

<mark style="color:red;">\*애플은 스크린샷 이미지를 아이폰 2가지 버전으로 제출합니다.</mark>
...
<figure><img src="../../../.gitbook/assets/89 (1).png" alt=""><figcaption></figcaption></figure>
...
\-사용자분의 애플 계정으로 올릴 경우, 애플 개발자 계정을 먼저 만들어주시구요.

– [**\[애플 개발자 등록 사이트\]**](https://developer.apple.com/)에서 계정을 만든뒤, 개발자 이용료 **1년 129,000원**을 결제해주셔야 합니다.

(애플 개발자 계정은 반드시 위의 사이트에서 계정 등록을 해주셔야 합니다. 개인 계정이 아니에요\~)

\-계정 등록한 뒤 IOS 아이디, 비밀번호를 신청서에 기재해주시면 됩니다.
