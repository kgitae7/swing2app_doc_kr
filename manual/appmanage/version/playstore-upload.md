...
플레이스토어 스크린샷 이미지는 정해진 사이즈가 없으며, 구글플레이에서제공하는규격을 확인하여 맞춰서 등록해주셔야 합니다.

**-휴대전화 스크린샷 최소2\~최대8장 등록**\
**-스크린샷은 PNG 또는 JPEG**\
**-장당 최대 8MB**\
**-가로세로 비율 16:9 또는 9:16**\
**-가로세로 길이는 (최소)320px \~ (최대)3840px 사이여야 합니다.**

\*일반적으로 안드로이드폰에서 앱 실행화면 캡처하여 제출하면 100%규격에 일치하오니, 안드로이드폰에서 화면 캡처 후 등록해주시면 됩니다.&#x20;
