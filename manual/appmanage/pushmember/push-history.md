...
{% hint style="info" %}
**1)발송 회원수는 1,000명인데, 실제 발송 완료된 수치는 500개 밖에 집계가 안되요. 왜 그런가요?**

or&#x20;

**앱 등록 기기수는 1,000개가 넘는데 , 실제 발송 수는 500개 밖에 집계가  안되요, 왜 그런가요?**

<mark style="color:purple;">**앱 설치수/회원 수 > 푸시 발송 수**</mark>

\= 2개 문의 모두, 앱을 설치한 수 보다 발송수가 적을 경우 물어보는 케이스입니다.
...
\*그리고 앱을 삭제한 경우 추적이 되지 않기 때문에 등록된 기기수가 실제 이용 중인 수 보다 높게 집계됩니다.
{% endhint %}
...
<mark style="color:purple;">**회원 수 < 푸시 발송 수**</mark>
